...
export default function IntroSection() {
  return (
    <section className="grid gap-2">
      ...
      <Para>
        Now, I&apos;m <strong>seeking a challenge</strong>. I thrive in
        innovative environments where collaboration is key to tackling complex
        technical problems. 🛠️
      </Para>
      <Para>Let&apos;s build something great together!</Para>
    </section>
  );
}
